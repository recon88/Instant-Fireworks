...
public class CustomEntityFirework_1_12_R1 extends EntityFireworks {
	Player[] players = null;

	public CustomEntityFirework_1_12_R1(World world, Player... p) {
		super(world);
		players = p;
		this.a(0.25F, 0.25F);
	}
	...
	public static void spawn(Location location, FireworkEffect effect, Player... players) {
		try {
			CustomEntityFirework_1_12_R1 firework = new CustomEntityFirework_1_12_R1(((CraftWorld) location.getWorld()).getHandle(), players);
